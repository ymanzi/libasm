...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/18 08:24:07 by ymanzi            #+#    #+#             */
/*   Updated: 2020/10/18 09:33:38 by ymanzi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define READ(buffer, x)	r = ft_read(STDIN_FILENO, buffer, x); buffer[r] = 0; printf("`%s` taille:%ld\n", buffer, r);
